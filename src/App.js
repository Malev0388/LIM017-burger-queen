...
import IndexBreakfast from './components/Mesero/Breakfast/IndexBreakfast.js';//import Index from './components/Mesero/index.js';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/mesero' element={<IndexBreakfast/>}/>        <Route path='/menu' element={<IndexMenu/>} />
      </Routes>
    </BrowserRouter>
  );
}export default App;